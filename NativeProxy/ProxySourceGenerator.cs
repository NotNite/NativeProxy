...
namespace NativeProxy {
    public static class Loader {
        ...
        public static nint GetModuleHandle(string path) {
            // I would like to use LoadLibraryEx here, but it refuses to load
            // two modules of the same name without an absolute path.
...
";
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context) {
        ...
        context.RegisterSourceOutput(exportsPipeline, static (context, exports) => {
...
";
        ...
        var origPathPipeline = context.AnalyzerConfigOptionsProvider.Select((provider, ct) =>
            provider.GlobalOptions.TryGetValue("build_property.NativeProxy_OriginalPath", out var origPath)
                ? origPath
                : "null");
        context.RegisterSourceOutput(exportsPipeline.Combine(entrypointPipeline).Combine(origPathPipeline),
            static (context, pair) => {
